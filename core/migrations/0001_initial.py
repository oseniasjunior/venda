# Generated by Django 2.2.1 on 2019-05-15 23:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='product_group',
            field=models.ForeignKey(db_column='id_product_group', db_index=False, on_delete=django.db.models.deletion.DO_NOTHING, to='core.ProductGroup'),
        ),
        migrations.AddField(
            model_name='product',
            name='supplier',
            field=models.ForeignKey(db_column='id_supplier', db_index=False, on_delete=django.db.models.deletion.DO_NOTHING, to='core.Supplier'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('means_payment', models.ForeignKey(db_column='id_means_payment', db_index=False, on_delete=django.db.models.deletion.DO_NOTHING, to='core.MeansPayment')),
                ('sale', models.ForeignKey(db_column='id_sale', db_index=False, on_delete=django.db.models.deletion.DO_NOTHING, to='core.Sale')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='meanspaymentsale',
            index=models.Index(fields=['means_payment'], name='means_payme_id_mean_b0e46f_idx'),
        ),
        migrations.AddIndex(
            model_name='employee',
